...
class ListPage extends PureComponent<{}, ListState> {
    ...
    componentDidMount = () => {
        axios.get('http://alex-alex.b9ad.pro-us-east-1.openshiftapps.com/uploads')
            .then(response => {
    ...
    deleteFile = (id: any) => {
        axios.get('http://alex-alex.b9ad.pro-us-east-1.openshiftapps.com/uploads/delete/' + id) 
            .then((response) => {
                ...
                <div className="ListImageContainer">
                    {this.state.imageList.map((file) => (
                        <div className="ListImage">
                            ...
                            <img
                                src={'http://alex-alex.b9ad.pro-us-east-1.openshiftapps.com/uploads/image/' + file.filename}
                                alt="list-image"
